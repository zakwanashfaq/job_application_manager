        ...
        <div className="item-container p-4" id={props.id}>
            <div className="col-11 col-sm-11 col-md-6">
                <div className='item-hover-container'>
                    <input className="checkbox" type="checkbox" title="checkbox" onChange={handleOnChange} placeholder="checkbox" value={isSelected} />
                    <strong className="job-name">{props.name}</strong>
                    ...
                    <div className='item-hover-toolbar-delete-button ps-4'>
