    ...
    return (
        <>
            <div className="loginPage-container container-fluid p-0 m-0">
                <div class="form-signin w-100 h-100 d-flex justify-content-center align-items-center">
                    <div className="loginPage-mainComponent-container">
                        <div className="d-flex flex-column justify-content-center align-items-center">
                            <h1 class="fs-1 fw-bold nav-brand-text mb-4">resJam</h1>
                            <h4 class="h4 fs-5 mb-3 fw-normal">Please sign in</h4>
                        </div>
                        ...
                        <button class="btn button-theme-color w-100 py-2 mt-4" type="submit">Sign in</button>
                        <hr />
                        <p class="my-3 text-body-secondary d-flex justify-content-center align-items-center">
